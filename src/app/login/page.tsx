...
import { getGroupMessages, GROUP_BRAND_ASSET_VERSION } from '@/lib/group-ui'
      ...
      <section className="group-login-shell">
        <div className="group-login-brand">
          <div className="group-brand-badge is-large is-centered">
            <Image src={`/brand/logo-anclora-group.png?v=${GROUP_BRAND_ASSET_VERSION}`} alt="Anclora Group" width={92} height={92} className="group-brand-logo" />
          </div>
          <h1>Anclora Group</h1>
          <p>{ui.loginTitle}</p>
        </div>
